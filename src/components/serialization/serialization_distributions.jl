...
const Params::UInt8 = 0x01

const None::UInt8 = 0x02

function to_string(dist_data::UInt8)
    if dist_data == DistributionsData.Params
        return "params"
...
function __show_distribution_type(io::StructuralContext, serialization::JSONSerialization, value::Distribution)
    show_key(io, :type)
    T = typeof(value)
...
function __show_distribution_tag(io::StructuralContext, serialization::JSONSerialization, value::Distribution)
    show_key(io, :tag)
    T = typeof(value)
