...
const _property_types_ServerInfo = Dict{Symbol, String}(
    Symbol("rxinfer_version") => "String",
    Symbol("server_version") => "String",
    Symbol("server_edition") => "String",
    Symbol("julia_version") => "String",
    Symbol("api_version") => "String"
)
