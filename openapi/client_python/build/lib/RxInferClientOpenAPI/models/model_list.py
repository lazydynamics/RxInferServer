...
class ModelList(BaseModel):
    ...
    ModelList
    """ # noqa: E501
    models: List[LightweightModelDetails] = Field(description="List of available models")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [LightweightModelDetails.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None
        })
        return _obj
