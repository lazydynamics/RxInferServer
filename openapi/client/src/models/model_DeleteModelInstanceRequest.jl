...
Base.@kwdef mutable struct DeleteModelInstanceRequest <: OpenAPI.APIModel
    ...
    function DeleteModelInstanceRequest(model_id, )
        OpenAPI.validate_property(DeleteModelInstanceRequest, Symbol("model_id"), model_id)
        return new(model_id, )
    end
end # type DeleteModelInstanceRequest

const _property_types_DeleteModelInstanceRequest = Dict{Symbol,String}(Symbol("model_id")=>"String", )
