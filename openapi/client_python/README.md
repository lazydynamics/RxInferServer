...
import RxInferClientOpenAPI
from RxInferClientOpenAPI.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost:8000/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = RxInferClientOpenAPI.Configuration(
...
with RxInferClientOpenAPI.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = RxInferClientOpenAPI.AuthenticationApi(api_client)

    try:
        # Generate authentication token
        api_response = api_instance.generate_token()
        print("The response of AuthenticationApi->generate_token:\n")
        pprint(api_response)
